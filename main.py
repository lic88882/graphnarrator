...
def auto(args):
    ...
    assert (args.resume > 0 and args.resume_model_id != "Qwen/Qwen2.5-1.5B-Instruct") or (
        args.resume == 0 and args.resume_model_id == "Qwen/Qwen2.5-1.5B-Instruct"
    ), "Invalid model id!"
...
def parse():
    ...
    parser.add_argument("--resume_model_id", type=str, default="Qwen/Qwen2.5-1.5B-Instruct", help="the model id to resume from")
